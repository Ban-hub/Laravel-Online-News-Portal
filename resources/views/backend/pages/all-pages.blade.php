...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="search-div">
      <div class="col-sm-9">
        All({{$all_posts}}) | <a href="#">Published ({{$published}})</a>
      </div>
    ...
    <form method="post" action="{{url('multiple-delete')}}">
      <div class="filter-div">
        ...
        <input type="hidden" name="tblid" value="{{encrypt('page_id')}}">
          <div class="col-sm-2">
        ...
        <div class="content">
          <table class="table table-striped" id="myTable">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <input type="checkbox" name="select-data[]" value="{{$post->page_id}}"> 
                  <a href="{{url('edit-page')}}/{{$post->page_id}}">{{$post->title}}</a>
                </td>
                <td>{{$post->status}}</td>
              ...
              @else
              <tr>
                <td colspan="4">No Pages to Display</td>
              </tr>
              @endif
            </tbody>
          </table>
