...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-12">
			<div class="row">
				<form method="post" action="{{url('update-adv')}}/{{$data->aid}}" enctype="multipart/form-data">
					{{ csrf_field() }}
					...
					<div class="col-sm-12">
						...
						<div class="form-group content featured-image">
                            ...
                            @if($data->image != '')
							<p><img id="output" src="{{url('public/advertisements')}}/{{$data->image}}" style="max-width: 100%"/></p>	
